...
puts "currently it is #{weather_data[:current][:temperature]} degrees and #{weather_data[:current][:conditions]}. Tomorrow it will be #{weather_data[:forecast][0][:temperature]} and #{weather_data[:forecast][0][:conditions]}. The following day it will be #{weather_data[:forecast][1][:temperature]} and #{weather_data[:forecast][1][:conditions]}."